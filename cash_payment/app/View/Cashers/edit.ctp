...
<?php echo $this->Form->create('Casher'); ?>
	<fieldset>
		<legend><?php echo __('Edit Casher'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Casher.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Casher.id'))); ?></li>
