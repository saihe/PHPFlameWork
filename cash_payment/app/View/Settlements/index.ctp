<div class="settlements index">
	...
	<tr>
		<td><?php echo h($settlement['Settlement']['id']); ?>&nbsp;</td>
		<td><?php echo h($settlement['Settlement']['type']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $settlement['Settlement']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $settlement['Settlement']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $settlement['Settlement']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $settlement['Settlement']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
