<div class="related">
	<h3><?php echo __('Affiliation_type'); echo __('Related Customers'); ?></h3>
	...
	<?php foreach ($customers as $customer): ?>
		<tr>
			...
			<td><?php echo h($customer['Affiliation']['affiliation_type']); ?></td>
			<td><?php echo h($customer['Primary']['primary_type']); ?></td>
			<td><?php echo $customer['Customer']['customer_name']; ?></td>
			<td><?php echo $customer['Customer']['tel']; ?></td>
			<td><?php echo $customer['Customer']['email']; ?></td>
			<td><?php echo h($customer['Answer']['type']); ?></td>
